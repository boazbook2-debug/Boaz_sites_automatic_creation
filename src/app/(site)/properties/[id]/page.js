...
export default async function PropertyDetailPage({ params }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-4 sm:py-6 lg:px-10">
      ...
      <div className="mt-5 grid gap-6 sm:mt-8 sm:gap-8 lg:grid-cols-[1fr_360px] lg:gap-12">
        <div>
          <div className="flex flex-wrap items-start justify-between gap-2 sm:gap-4">
            <div>
              <h1 className="text-2xl font-serif font-bold tracking-tight sm:text-4xl lg:text-5xl">{property.title}</h1>
              <p className="mt-1 text-sm text-[var(--color-main)]/60 sm:text-lg">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 rounded-2xl bg-[var(--color-surface)] p-3 text-center shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] sm:mt-6 sm:gap-4 sm:rounded-[2rem] sm:p-6">
            <div>
          ...
          <div className="mt-5 sm:mt-8">
            <h2 className="font-serif text-lg font-bold sm:text-2xl">מאפייני הנכס</h2>
      ...
      <div className="mt-6 sm:mt-10">
        <LeadForm propertyTitle={property.title} toWhatsapp={agent?.whatsapp} />
      </div>

      {similar.length > 0 && (
        <div className="mt-6 sm:mt-12">
          <h2 className="mb-3 text-lg font-serif font-bold tracking-tight sm:mb-6 sm:text-3xl">נכסים דומים</h2>
