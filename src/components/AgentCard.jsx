...
export default function AgentCard({ agent, compact = false, className = "" }) {
  if (compact) {
    return (
      <Link
        ...
        className={`flex flex-col items-center rounded-2xl bg-[var(--color-surface)] p-4 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(0,0,0,0.12)] sm:rounded-[2rem] sm:p-8 ${className}`}
      >
        <SampleImage
          src={agent.photo}
          alt={agent.name}
  ...
  return (
    <div
      className={`flex flex-col items-center rounded-2xl bg-[var(--color-surface)] p-4 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(0,0,0,0.12)] sm:rounded-[2rem] sm:p-6 ${className}`}
    >
      <SampleImage
        src={agent.photo}
        alt={agent.name}
